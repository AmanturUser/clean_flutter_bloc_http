...
import 'package:flutter_bloc_get_clean/feature/todo_feature/presentation/bloc/todo_bloc.dart';
import 'package:flutter_bloc_get_clean/feature/todo_feature/presentation/todo_page/widgets/popup_menu_item_widget.dart';
        ...
        child: SizedBox(
          ...
          child: BlocBuilder<TodoBloc, TodoState>(builder: (context, state) {
            ...
            if (state is LoadedTaskState) {
              ...
              return count>0 ? ListView.separated(
                  ...
                  separatorBuilder: (BuildContext context, int index) =>
                      const Divider(),
                  itemCount: count):Center(child: Text("У вас нету задач"),);
            }
